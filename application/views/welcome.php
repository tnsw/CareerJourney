...
<html lang="en">
  <head>
    ...
    <title>TfNSW Career Journey Prototype</title>

    <!-- Bootstrap core CSS -->
    <link href="<?php echo asset_url();?>css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?php echo asset_url();?>css/cover.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="mastfoot">
            <div class="inner">
              <p>Developed by <a href="mailto:Pak.NG@transport.nsw.gov.au">Pak Ng</a>.</p>
            </div>
          </div>
    ...
    <script src="<?php echo asset_url();?>js/docs.min.js"></script>
  </body>
</html>
